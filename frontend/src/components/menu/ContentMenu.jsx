        ...
        <>
            ...
            <li>
                <Link to="/create-post"
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap">My posts</span>
                    <span
                        className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-300 bg-gray-700 rounded-full">Pro
              </span>
                </Link>
            </li>
            <li>
                ...
                >
                    ...
                    <span
                        className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-300 bg-blue-900 rounded-full">
                3
              </span>
                </Link>
            </li>
